...
class InteractionContext {
  ...
  factory InteractionContext.fromJson(Map<String, dynamic> json) {
    return InteractionContext(
      ...
      attributes: json['attributes'] != null ? Map<String, dynamic>.from(json['attributes'] as Map) : null,
    );
  }
...
class SnapshotContext {
  ...
  factory SnapshotContext.fromJson(Map<String, dynamic> json) {
    return SnapshotContext(
      timestamp: json['timestamp'] is int ? json['timestamp'] : (json['timestamp'] as num?)?.toInt() ?? 0,
